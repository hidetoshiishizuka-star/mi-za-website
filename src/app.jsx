  ...
  return (
    <>
      ...
      <Sec>
        ...
        <F>
          <P>超高齢社会が本格化し、住み慣れた場所で最期まで過ごすことを望む人が増え続けています。その現場を担っているのは、全国のクリニックの院長たちです。</P>
          <P>在宅医療の事務長時代、全国の研修会で、院長先生たちからよく声をかけられました。「事務長を探しているが、どういうキャリアの人が良いと思う？」「そばで何でも相談に乗ってくれる人がほしい」——。一医療機関を超えて、院長の力になりたい。そう思い立ち、思い切ってMI-ZAをひとりで立ち上げました。立ち上げからまもなく8年、2026年1月に法人化いたしました。いまは、現役の在宅事務長でもある取締役・石塚秀俊とともに運営しています。</P>
          <P>経営上の課題の裏には、たいてい人の事情があります。スタッフが辞めるのも、院長が判断に迷うのも、数字だけを見ていては解けません。MI-ZAは、そこを織り込んだうえで、判断の根拠をデータでつくります。在宅医療のデータ活用・AI活用の研究にも取り組んでいます。経験と直感を大切にしながら、その判断をデータで裏付けられる——そんな経営の仕組みを、院長と一緒につくっていきたいと考えています。</P>
        </F>
      </Sec>

      <Sec bg={C.bg}>
        <SH en="TEAM" ja="担当者紹介" />
        <F><P style={{ marginBottom: 32 }}>在宅医療クリニックが変わるには、現場の事情を織り込むことと、変えるべきことを変える決断——その両方が必要だと考えています。</P></F>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(261px, 1fr))", gap: 28, marginBottom: 28 }}>
          {[
            { role: "CEO", img: "photo-ceo.jpg", name: "代表取締役　石塚（波村）美絵", desc: "九州大学大学院法学府修了。琉球大学講師を経て、在宅医療クリニックの事務長として約10年。医療が届く仕組みを、現場の人と一緒につくる。", alt: "石塚美絵 MI-ZA代表 在宅医療コンサルタント" },
            { role: "DIRECTOR", img: "photo-director.jpg", name: "取締役　石塚 秀俊", desc: "東京工業大学大学院修了。伊藤忠商事、アクセンチュアを経て、医療法人の事務長・統括マネジャーとして全事業所の黒字化を達成。現在も在宅療養支援診療所の事務長。", alt: "石塚秀俊 MI-ZA取締役 在宅医療コンサルタント" },
          ].map((m, i) => (
            <F key={i} delay={i * 0.1}>
...
function Member({ go }) {
  const MEMBERS = [
    { role: "CEO", img: "photo-ceo.jpg", alt: "在宅医療・訪問診療クリニック専門 経営コンサルタント・事務長支援 石塚美絵（波村美絵）代表取締役 MI-ZA", name: "代表取締役　石塚（波村）美絵", bio: "在宅医療を必要とする人に、必要な医療が届く。その仕組みを、そこで働く人と一緒につくるのが、私の役割です。\n\n九州大学大学院法学府を修了後、琉球大学で法学を教えていました。学生に法を説きながら、法律は弱い立場の人を守る力を持つ一方で、その人を直接支えるには遠すぎる——そう感じるようになります。\n\nもっと身近で人を支えたい。病院の医療ソーシャルワーカーへ転じ、患者さんと向き合うなかで気づいたのは、病院からは見えない暮らしがあるということでした。その人の家に上がり、家族を知り、人生ごと診る。在宅医療の考えに深く共鳴しました。身近な人が在宅医療を知らないまま苦しんだ経験も、この道を選ぶ後押しになりました。\n\n訪問診療クリニックの事務長として約10年、運営に携わってきました。診療の質を保ちながら仕組み化を進め、残業に苦しんでいたスタッフの残業を半年でゼロに。決して一足飛びではありません。部署の中の工夫では届かず、部署をまたいで仕事を移しました。スタッフが前に進めなくなったときの合意形成を支えることも、事務長の仕事だと考えています。\n\n医療は、届いてはじめて意味を持ちます。その最後の一歩を支えていきます。\n\n九州大学大学院法学府 修了\n順天堂大学大学院 ヘルスケアマネジメントプログラム 入門・修了（2018年）\n一般社団法人日本在宅医療事務連絡会 理事", skill: "得意領域：組織の意思決定の流れをつくる（組織プロセスファシリテーション）、診療報酬改定対応、医療広告・HP運用、人事労務整備、医師採用・定着支援、事務長・管理職育成" },
    { role: "DIRECTOR", img: "photo-director.jpg", alt: "在宅医療・訪問診療クリニック専門 経営コンサルタント 石塚秀俊 取締役 MI-ZA", name: "取締役　石塚 秀俊", bio: "院長の判断の質を上げ、決めたことを実行できる体制を整える。それが、私の役割です。\n\n東京工業大学大学院を修了後、伊藤忠商事へ。豪州駐在4年を含め、新規事業の立ち上げとM＆Aを中心に携わりました。その後、ガリバーインターナショナルで経営企画部長・マーケティング部長・FC事業部長・人事部長を歴任します。\n\n医療・介護の現場へ転じてからは、訪問診療・訪問看護ステーションの統括部長を務めました。医療機関・介護事業所を50カ所以上運営する医療法人では、事務長・統括マネジャーとして全事業所の黒字化を達成しています。\n\nその後、アクセンチュアでシニア・プリンシパルとして、経営・ヘルスケア領域のコンサルティングに従事しました。2025年には、日本の医療法人によるベトナムでのクリニック2拠点立ち上げに、事業開発部長として携わりました。\n\n現在も、在宅療養支援診療所の事務長として現場に立っています。MI-ZAでお渡しするAIの仕組みは、まず自分の現場で使い、成果を確かめてからご提供しています。\n\n組織を変える仕事を積み重ねるなかで、変化が起きる組織と起きない組織の違いを繰り返し見てきました。現場の状況を正確に読み、変えるべきことを明確に決める——それが、院長の経営判断を支える力になると考えています。\n\n東京工業大学大学院 修了\n一般社団法人日本在宅医療事務連絡会 代表理事", skill: "得意領域：生成AI実装・医療DX（レセプト/書類業務の自動化・データ活用）／経営判断支援・事業計画策定／診療報酬改定対応（在宅医療・訪問看護）／マーケティング・集患・連携先開拓／訪問看護の組織運営・管理職育成" },
  ];
  return (
    <>
      <section style={{ background: C.navy, paddingTop: 108, paddingBottom: 48, textAlign: "center" }}>
            ...
            <div style={{ paddingBottom: i === 0 ? 40 : 0, marginBottom: i === 0 ? 40 : 0, borderBottom: i === 0 ? `2px solid ${C.line}` : "none" }}>
              ...
              {m.bio.split("\n\n").map((para, j) => (
                <P key={j} style={{ fontSize: 14 }}>
                  {para.split("\n").map((line, k) => (
                    <React.Fragment key={k}>{k > 0 && <br />}{line}</React.Fragment>
                  ))}
                </P>
              ))}
              {m.skill && <P style={{ fontSize: 13, fontWeight: 600, color: C.navy }}>{m.skill}</P>}
            </div>
          </F>
        ))}
      </Sec>
    ...
    <footer style={{ background: C.navy, padding: "53px 25px 33px" }}>
      <div style={{ maxWidth: 960, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", gap: 20, justifyContent: "center", alignItems: "center", marginTop: 36, paddingTop: 24, borderTop: "2px solid rgba(255,255,255,0.07)" }}>
          ...
          <a href="https://www.threads.com/@miza_ai_zaitaku" target="_blank" rel="noopener noreferrer" title="Threads" style={{ color: "rgba(255,255,255,0.3)", textDecoration: "none", display: "inline-flex", transition: "color 0.2s" }} onMouseOver={e => e.currentTarget.style.color = "rgba(255,255,255,0.7)"} onMouseOut={e => e.currentTarget.style.color = "rgba(255,255,255,0.3)"}>
            <svg width="20" height="20" viewBox="0 0 192 192" fill="currentColor" style={{ display: "block" }}><path d="M141.537 88.9883C140.71 88.5919 139.87 88.2104 139.019 87.8451C137.537 60.5382 122.616 44.905 97.5619 44.745C97.4484 44.7443 97.3355 44.7443 97.222 44.7443C82.2364 44.7443 69.7731 51.1409 62.102 62.7807L75.881 72.2328C81.5176 63.7042 90.3635 61.7752 97.2286 61.7752C97.3051 61.7752 97.3819 61.7752 97.4576 61.7758C106.027 61.8307 112.49 64.3242 116.629 69.1126C119.638 72.5984 121.65 77.4197 122.65 83.5159C115.105 82.2243 106.972 81.832 98.2861 82.342C73.7211 83.7591 57.926 98.0901 58.99 117.997C59.5288 128.094 64.5687 136.758 72.7553 142.391C79.6839 147.156 88.6182 149.483 97.9101 148.974C110.241 148.293 119.937 143.572 126.745 134.972C131.918 128.439 135.183 119.974 136.65 109.279C142.728 112.972 147.235 117.835 149.704 123.701C153.913 133.61 154.157 149.917 140.927 163.337C129.302 175.082 115.32 180.166 94.1227 180.318C70.7136 180.144 53.0173 172.638 41.5256 158.005C30.7615 144.232 25.2 124.355 25 99.0001C25.2 73.6453 30.7615 53.7681 41.5256 39.9952C53.0173 25.3625 70.7136 17.8567 94.1227 17.6826C117.701 17.8579 135.667 25.3784 147.305 40.0497C153.014 47.2147 157.32 56.2289 160.157 66.6918L177.512 62.0688C174.081 49.0867 168.685 37.8673 161.349 28.4805C146.563 9.55479 124.892 -0.0561162 94.1893 0H94.0561C63.4163 0.0594198 41.9942 9.70675 27.4895 28.6906C14.5848 45.5837 7.92799 69.0682 7.7041 98.9304L7.70312 99.0001L7.7041 99.0697C7.92799 128.932 14.5848 152.417 27.4895 169.31C41.9942 188.293 63.4163 197.941 94.0561 198H94.1893C121.434 197.946 140.643 190.812 156.461 175.018C177.149 154.354 176.526 128.456 169.708 112.595C164.815 101.21 155.495 91.9621 141.537 88.9883ZM98.4405 132.029C88.1614 132.609 77.4805 127.984 76.954 117.94C76.5594 110.451 82.2722 102.099 99.252 101.121C101.197 101.009 103.106 100.954 104.982 100.954C111.169 100.954 116.953 101.555 122.226 102.704C120.241 127.453 108.595 131.471 98.4405 132.029Z"/></svg>
          </a>
        </div>
