          ...
          {[
            {
              n: "01",
              t: "事務長養成プログラム（動画版）",
              d: "事務長10年の経験から、在宅医療クリニックの事務長業務を体系化した全12回（各1時間）の動画教材＋パワポ資料。買い切り型で何度でも視聴可能、新任事務長の研修にも最適です。",
              tag: "動画教材／買い切り",
              price: "¥49,800（税別）",
              priceNote: "🎁 発売記念 先着50名様 ¥39,800（税別）／ 動画12本×各1時間＋パワポ資料・期間制限なし・繰り返し視聴可",
              cta: "販売開始のお知らせを受け取る",
              ctaHref: "/contact/",
              ctaPage: 6,
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 20, maxWidth: 960, margin: "0 auto" }}>
            ...
            <div style={{ background: C.bg, padding: "24px 22px", borderTop: `4px solid ${C.gold}` }}>
              ...
              <ol style={{ paddingLeft: 18, margin: 0 }}>
                {["申込フォーム送信","キックオフ面談（30分Zoom）","電子契約締結（freeeサイン）","初期設定（無料・通常2〜4週間）","Go-Live承認・サービス開始"].map((t, i) => (
  ...
  return (
    <>
      ...
      {submitted ? (
        ...
        <Sec>
          <F><P>フォームをお送りいただくと、3営業日以内にご連絡します。その後、Zoomで30分、現状をゆっくりお聞きします。ご依頼いただくかどうかは、そのあとで決めていただけます。</P></F>
