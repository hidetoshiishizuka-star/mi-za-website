...
const PAGES = [
  { ja:"ホーム",       en:"HOME",    url:"/",          title:"MI-ZA（ミーザ）｜在宅医療AI伴走サービス・組織運営支援・医療DX支援",    desc:"在宅医療・訪問診療クリニック専門のコンサルティング会社MI-ZA（ミーザ）。在宅医療の経営支援・事務長支援・組織運営支援・生成AI実装・医療DX支援・ホームページ制作まで対応。" },
      ...
      <Sec py={56} bg={C.white}>
        <F>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 20, maxWidth: 920, margin: "0 auto" }}>
            {[
              { ic: "01", t: "在宅事務長 10年以上の現場力", d: "代表・役員は在宅事務長10年超の経験を有し、多くのクリニックで業務の仕組み化・組織運営・診療報酬最適化・トラブル対応等を実体験で蓄積・共有しています。難しいスタッフの中でも数多くの成果を実現しています。", img: "photo-jimucho-desk.jpg", alt: "在宅医療事務長の業務イメージ — 計算機とノート" },
